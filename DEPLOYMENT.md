...
> **Note**: If port 80 is already in use (e.g., by LiteSpeed, Apache, or Nginx), the application defaults to port **8080**. See `LITESPEED_SETUP.md` for LiteSpeed integration instructions.
...
- `APP_PORT`: Port for the application (default: `8080` if port 80 is in use)
- `APP_URL`: Your domain URL (e.g., `https://yourdomain.com`) or `http://YOUR_SERVER_IP:8080`
